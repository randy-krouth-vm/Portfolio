...
function App() {
  ...
  return (
    <>
          ...
          <ImageGrid imageOne="Image_17.png" imageOneText="Interactive Web Design"
              imageTwo="Image_18.png" imageTwoText="Containerized Web Development" />
          <SectionThree />
          <ImageGrid imageOne="Image_15.png" imageOneText="Automated Agentic Workflows"
              imageTwo="Image_16.png" imageTwoText="Custom Database Integrations & Dashboards" />
